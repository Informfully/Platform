...
export default class ModalCreateExperiment extends Component {
    ...
    handleSubmit(event) {
        ...
        Meteor.call('experiments.create', name, (err, res) => {
            if (err) {
                this.setState({
            ...
            if (res) {
                Session.set('selectedExperiment', res);
                this.hide();
            }
        });
    }
